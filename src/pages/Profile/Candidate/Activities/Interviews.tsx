    ...
    datasets: [
        {
            ...
            data: [108, 120], // Get these from the API
        ...
        <div>
            <div className="bg-[#eaf6f8] h-[280px] p-6 rounded-lg mb-6 flex justify-between">
                ...
                <div className="w-1/3 flex flex-col items-center h-full">
                    <h4 className="font-semibold mb-2 text-center">Response time (for the interviews)</h4>
                ...
                <div className="w-1/3 flex flex-col items-center h-full border-l-gradient">
                    <h4 className="font-semibold mb-2 text-center">Acceptance rate of interviews responses</h4>
            ...
            <div className="flex items-center justify-between mb-2">
                <h2 className="text-xl font-bold mb-4">Interview Topics</h2>
            ...
            <div className="space-y-4">
                {interviewTopics.map((item, index) => (
                                    ...
                                    <h6 className="text-primary text-lg underline flex items-center gap-1 relative">
                                        ...
                                        <div className="relative">
                                            <div className="group relative">
                                                ...
                                                <div className="absolute top-[-20px] left-1/2 -translate-x-1/2 bg-gray-900 text-white text-xs px-3 py-1 rounded-md shadow-md opacity-0 group-hover:opacity-100 transition-opacity duration-200 whitespace-nowrap pointer-events-none">
