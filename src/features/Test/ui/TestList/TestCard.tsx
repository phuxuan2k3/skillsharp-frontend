...
import { TestProps } from "../../../../legacy/candidate/tests/types";

const TestCard: React.FC<TestProps> = (props: TestProps) => {
	const { id, managerId, minutesToAnswer, company, createdAt, title, tags, answerCount } = props;
	...
	const handleOnCardClick = () => {
		navigate(paths2.candidate.tests.id(id).ATTEMPTS, {
			state: props
		});
	}
